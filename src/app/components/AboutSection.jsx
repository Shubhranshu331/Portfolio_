...
const Counter = ({ end, duration = 2000, trigger }) => {
  ...
  useEffect(() => {
    if (!trigger) return; // only animate when trigger is true
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[2vw] md:grid md:grid-cols-4">
        {/* Columns 1-2: Personal Information */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[2vw]">
              <ul className="text-[#222222] font-lato text-[1rem] min-w-0">
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Name</span><br />Shubhranshu
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Age</span><br />23
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Status</span><br />
                  <span className="font-bold text-[#16a34a]">Open to Work</span>
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Phone</span><br />+91-8957484331
                </li>
              </ul>
              <ul className="text-[#222222] font-lato text-[1rem] min-w-0">
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Nationality</span><br />Indian
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Address</span><br />Uttar Pradesh, India
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Languages</span><br />English and Hindi
                </li>
                <li className="mb-[1.5vh] text-center break-words">
                  <span className="font-bold text-[#5e2a3a] text-[1.2rem]">Email</span><br />shubhranshu331@gmail.com
                </li>
              </ul>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[2vw]">
                    ...
                    >
                      <div className="border-[2px] border-[#5e2a3a] rounded-lg w-[3vw] h-[3vw] min-w-[60px] min-h-[60px] flex justify-center items-center">
                        <span className="text-[#5e2a3a] text-[1.25rem] font-raleway font-bold">
                          <Counter end={progress.value} duration={2000} trigger={hasAnimated} />
                          {progress.postfix}
                        </span>
                      </div>
                    </motion.div>
              ...
              <div className="min-w-0">
                {progressList.slice(3).map((progress, index) => (
                  <div key={index + 3} className="flex flex-col mb-[3vh] items-center justify-center">
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.5, delay: index * 0.1 }}
